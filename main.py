...
class MainWindow(QtWidgets.QWidget):
    ...
    def on_change(self, s):
        ...
        #    self.ui.p1_0_0.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_1.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_2.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_3.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_4.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_5.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_6.setStyleSheet("background-color : #f95a5a")
#
        ...
        #    self.ui.p1_0_7.setStyleSheet("background-color : #f95a5a")
